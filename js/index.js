...
$(function() {
	...
	function animAuto() {
		...
		q.queue(function() {
			$(".animElem1").animate({top: "170px"}, 1000, function() {
            	$(this).addClass("rotate10");
            });
		}).wait(1000)
		.queue(function() {
			$(".animElem2").animate({top: "170px"}, 1000, function() {
            	$(this).addClass("rotate-10");
            });
		}).wait(1000)
		.queue(function() {
			$(".animElem3").animate({top: "170px"}, 1000, function() {
            	$(this).addClass("rotate10");
            });
		}).wait(1000)
		.queue(function() {
			$(".animElem4").animate({top: "170px"}, 1000, function() {
            	$(this).addClass("rotate-10");
            });
		}).wait(1000)
		.queue(function() {
			$(".animElem5").animate({top: "170px"}, 1000, function() {
            	$(this).addClass("rotate10");
            });
		}).wait(1000)
		.queue(function() {
